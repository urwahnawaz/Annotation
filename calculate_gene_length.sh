...
gene_length=/apps/software/Trinity/2.5.1-foss-2016b/trinityrnaseq-Trinity-v2.5.1/util/misc/TPM_weighted_gene_length.py

 $gene_length --gene_trans_map $DIR/Trinity.fasta.gene_trans_map \
